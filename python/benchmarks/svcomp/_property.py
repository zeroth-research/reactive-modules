...
reach an LP — belongs to the procedure, not here. So a property is stateable without knowing which procedure will take it, and a
procedure declares which properties it can discharge.
