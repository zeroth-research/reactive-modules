...
from .expr import expr, cast, ite, relu, argmax, exp, clkrate, collecting, Expr, X as expr_X, d as expr_d  # re-exported for authoring

# Public authoring surface: `from zrth.sugar import Module, expr, X, d, ite, cast, ...`
__all__ = ["Module", "expr", "cast", "ite", "relu", "argmax", "exp", "clkrate", "Expr", "X", "d", "Var"]
