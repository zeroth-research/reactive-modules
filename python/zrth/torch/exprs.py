...
from zrth.expr import Expr as ExprBase
from random import randrange

from typing import Callable, Any
from torch import Tensor

from .ll import DType, IType, Term, Wire
...
class Expr(ExprBase):
    def __init__(self, op: str, *args):
        ...
        # until we have a global context, we have to pass it explicitely
        super().__init__(op, list(args) if op != "sym" else [])
